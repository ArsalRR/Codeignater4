...
<div class="row mb-3">
<label for="cover" class="col-sm-2 col-form-label">Total Biaya Produksi</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="cover" name="total_biaya_pr">
</div>
</div>
<div class="row mb-3">
<label for="cover" class="col-sm-2 col-form-label">Total Pendapatan</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="cover" name="total_pendapat">
</div>
</div>
<div class="row mb-3">
<label for="" class="col-sm-2 col-form-label">Input Bulanan</label>
<div class="col-sm-10">
